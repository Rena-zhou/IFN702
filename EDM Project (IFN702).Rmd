...
ggplot(data = E, aes(x = PlaceofBirth, fill = Class)) + geom_bar() +
    labs(x = "PlaceofBirth", y = "Student Count")
```
...
+ scale_x_continuous(breaks = seq(0,100,5)) + labs(x = "Raised Hands", y = "Student Count") + ggtitle("Frequency histogram of Raisehands")
