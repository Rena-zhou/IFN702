...
E
# Stratified sampling
TrainingDataIndex <- createDataPartition(E$Class, p=0.75, list = FALSE)
...
trModel <- train(trainingData[,-17], trainingData$Class,
                  method = "rpart",
...
```{r}
# train model with randomforest networks
rfModel <- train(trainingData[,-17], trainingData$Class,
                  method = "rf",
                  trControl= TrainingParameters,
